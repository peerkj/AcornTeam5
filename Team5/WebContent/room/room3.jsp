...
.room1-02 { background-image: url(image/room3-2.jpg); }
.room1-03 { background-image: url(image/room3-3.jpg); }
.room1-04 { background-image: url(image/room3-4.jpg); }
.room1-05 { background-image: url(image/room3-5.jpg); }
.room1-06 { background-image: url(image/room3-6.jpg); }
.roomcontent-group{
   width: 100%;
   height: 100%;
...
<div class="roomcontent-group">
   <div class="roomcontent">
      <div class="box1" style="width: 100%;">
         ...
         <img src="<%=url %>/image/room3-2.jpg" style="width: 1000px; height: 600px; float: right;">
         
      </div>
      <br>
      <div class="box2" style="width: 100%;">
         <img src="<%=url %>/image/room3-4.jpg" style="width: 900px; height: 500px;">
      ...
      <div class="box3" style="width: 100%;">
         <img src="<%=url %>/image/room3.jpg" style="width: 1050px; height: 600px; margin-left: 200px;">
      </div>
   </div>
   <div id="pricegroup">
		<table id="pricetb">
