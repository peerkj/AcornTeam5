...
<div class="form">
   ...
   <img src="https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fk.kakaocdn.net%2Fdn%2FkDN1L%2FbtqDhuX4ooQ%2FWY72cyF2e4frBUyLACEryK%2Fimg.png">
   </a>
   <form class="regi-form" action="registeraction.jsp" method="post">
      ...
      <br>
      <b>아이디</b><br>
      <input type="text" name="id" id="id" required="required" pattern="[a-z0-9._%+-]{5,}"  placeholder="아이디 입력"> 
      <font id="idchk" size="2"></font>
      <br>
      <b>비밀번호</b><br>
      <input type="password" name="pass" id="pass" required="required" placeholder="비밀번호 입력">
      <br>
      <b>비밀번호 확인</b><br>
         <input type="password" name="pass1" id="pass1" required="required" placeholder="비밀번호 다시 입력"> 
         <font id="passchk" size="2"></font>
      <br>
      <b>핸드폰</b><br>
         <input type="text" name="hp1" id="hp1" required="required"
         maxlength="4" pattern="^[0-9]{3}">&nbsp;&nbsp;<b>-</b>&nbsp;
      ...
      <b>이메일</b><br>
         ...
         required="required" pattern="[a-z0-9._%+-]{5,}">&nbsp;<b>@</b> 
