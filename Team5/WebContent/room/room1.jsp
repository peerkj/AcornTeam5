...
.room1-02 { background-image: url(image/room1-2.jpg); }
.room1-03 { background-image: url(image/room1-3.jpg); }
.room1-04 { background-image: url(image/room1-4.jpg); }
.room1-05 { background-image: url(image/room1-5.jpg); }
.room1-06 { background-image: url(image/room1-6.jpg); }
.roomcontent-group{
	width: 100%;
	height: 100%;
...
<div class="roomcontent-group">
	<div class="roomcontent">
		...
		<div class="box2" style="width: 100%;">
			<img src="<%=url %>/image/room1-3.jpg" style="width: 900px; height: 500px;">
