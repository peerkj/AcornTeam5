...
int price=Integer.parseInt(roomdao.getRoom("10").getPrice());
...
.room1-image {
    ...
    width: 100%;
    height: 1000px;
    background-image: url(image/room4.jpg);
    background-repeat: no-repeat;
    background-size: cover; /* contain:비율에 맞게 | cover: 비율무시  */    
}
.room1-02 { background-image: url(image/room4-2.jpg); }
.room1-03 { background-image: url(image/room4-3.jpg); }
.room1-04 { background-image: url(image/room4-4.jpg); }
.room1-05 { background-image: url(image/room4-5.jpg); }
.room1-06 { background-image: url(image/room4-6.jpg); }
.roomcontent-group{
   width: 100%;
   height: 100%;
   ...
   <div class="roomcontent">
      <div class="box1" style="width: 100%;">
         <div style="padding: 100px 50px;float: right;text-align: right;">
            <span class="roomname"><%=dao.getRoomName("10") %></span>
         ...
         <img src="<%=url %>/image/room4-2.jpg" style="width: 1000px; height: 600px; float: left;">
         
      </div>
      <br>
      <div class="box2" style="width: 100%;">
         <img src="<%=url %>/image/room4-4.jpg" style="width: 900px; height: 500px;float: right;">
      ...
      <div class="box3" style="width: 100%;">
         <img src="<%=url %>/image/room4.jpg" style="width: 1050px; height: 600px; margin-left: 200px;">
      </div>
   </div>
   <div id="pricegroup">
		<table id="pricetb">
